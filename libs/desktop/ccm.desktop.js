...
( function () {
    ...
    var component_obj = {
        ...
        config: {
            style: [
                ['ccm.load', 'https://ccmjs.github.io/akless-components/libs/desktop/styles/example/desktop.css']
            ],
            apps: [ "ccm.get", "https://ccmjs.github.io/akless-components/libs/desktop/apps_config.js", "example"],
            html_templates: {
                'main': {
                    tag: 'div',
                    class: 'main',
