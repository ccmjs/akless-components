    ...
    ;
{
    ...
    // are loaded.
    const issuedWarnings = ((_a$3 = globalThis.litIssuedWarnings) !== null && _a$3 !== void 0 ? _a$3 : (globalThis.litIssuedWarnings = new Set()));
...
let issueWarning$1;
{
    (_a$2 = globalThis.litIssuedWarnings) !== null && _a$2 !== void 0 ? _a$2 : (globalThis.litIssuedWarnings = new Set());
    // Issue a warning, if we haven't already.
...
const flyBelow = [{ transform: 'translateY(100%) scale(0)', opacity: 0 }];
const flyAbove = [{ transform: 'translateY(-100%) scale(0)', opacity: 0 }];
const flyLeft = [{ transform: 'translateX(-100%) scale(0)', opacity: 0 }];
const flyRight = [{ transform: 'translateX(100%) scale(0)', opacity: 0 }];
const none = [{}];
...
const defaultKeyframeOptions = {
    duration: 333,
    easing: `ease-in-out`,
};
const defaultCssProperties = [
    'left',
    'top',
    'width',
    'height',
...
class Position extends AsyncDirective {
    constructor(part) {
        super(part);
...
export { Animate, AnimateController, CSSResult, INTERNAL, LitElement, Position, ReactiveElement, Task, TaskStatus, UpdatingElement, _$LE, _$LH, adoptStyles, animate, animationFrame, asyncAppend, asyncReplace, cache, controllerMap, css, defaultConverter, defaultCssProperties, defaultKeyframeOptions, fade, fadeIn, fadeInSlow, fadeOut, flyAbove, flyBelow, flyLeft, flyRight, getCompatibleStyle, guard, html, ifDefined, initialState, live, noChange, none, notEqual, nothing, position, ref, render, repeat, supportsAdoptingStyleSheets, svg, transformProps, unsafeCSS, unsafeHTML, unsafeSVG, until };
