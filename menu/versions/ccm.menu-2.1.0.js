      ...
      this.start = async () => {
        ...
        function renderMenuEntry( entry_data, i ) {
          ...
          async function onClick() {
             ...
             * @type {Object}
             */
            const event_data = { title: entry_data.title, id: entry_data.id, nr: i + 1, selected: selected };
            ...
            function performActions() {
              ...
              // prepare event data
              event_data.content = content_elem; event_data.entry = entry_elem; delete event_data.selected;
