...
( () => {
  const component = {
    ...
    config: {
      ...
      "dashboard": {
        "title": "Dashboard",
        "app": [ "ccm.component", "https://ccmjs.github.io/akless-components/team_project_analytics/versions/ccm.team_project_analytics-2.1.1.js" ]
      },
...
//    "onchange": event => console.log( event ),
      "teambuild": {
        "title": "Teams",
        "app": [ "ccm.component", "https://ccmjs.github.io/akless-components/teambuild/versions/ccm.teambuild-5.1.0.js" ]
      },
      "tools": [
        {
          "key": "chat",
...
//    "user": [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.7.1.js" ]
    ...
    Instance: function () {
      ...
      let $, dashboard, main_elem, menu, source, team_data, team_nr, teambuild, tools = [];
