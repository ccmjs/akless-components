        ...
        const view = [
          ...
          async () => {
            ...
            if ( this.analytics )
              ...
              $.removeElement( content.querySelector( '#analytics_section' ) );
          ...
          async () =>  {
            ...
            $.removeElement( filters.querySelector( '#component_filter' ) );
            $.removeElement( filters.querySelector( '#language_filter' ) );
