...
( () => {
  ...
  const component = {
    ...
    name: 'image_map_builder', version: [ 1, 0, 0 ],
  ...
  //  "onchange": instance => console.log( instance.getValue() ),
      "submit": [ "ccm.component", "https://ccmjs.github.io/akless-components/submit/versions/ccm.submit-7.3.3.js", {
        "entries": [
          "<div class=\"page-header\"><h2>Settings <small class=\"text-primary\">Image Map</small></h2></div>",
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        config = await $.integrate( await $.dataset( this.data ), { data: { areas: [] } } );
