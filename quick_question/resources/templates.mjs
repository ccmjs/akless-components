    ...
    <section id="next" ?data-hidden=${add}>
      <article>
        ...
        <nav>
          ...
          <div title="${instance.text.neither}" @click=${event.neither}>
  ...
  <footer>
    <nav>
      ...
      <div class="button" title="${instance.text.confirm}" @click=${event.confirm} ?data-hidden=${!add}>
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48" style=" fill:#000000;"><path fill="#43A047" d="M40.6 12.1L17 35.7 7.4 26.1 4.6 29 17 41.3 43.4 14.9z"></path></svg>
        </div>
        <div>
