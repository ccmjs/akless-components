...

{
  var component = {
     ...
     * @type {string|Object}
     */
    ccm: 'https://ccmjs.github.io/ccm/versions/beta/ccm-16.0.0.min.js',
  ...
  //  placeholder: { foo: 'bar' }   // replaces all '%foo%' with 'bar'
    ...
    Instance: function () {
      ...
      this.init = callback => {
        ...
        // dynamic replacement of placeholders
        if ( self.placeholder ) [ ...self.inner.children ].map( child => child.innerHTML = $.format( child.innerHTML, self.placeholder ) );
