  ...
  //  placeholder: { foo: 'bar' }   // replaces all '%foo%' with 'bar'
    ...
    Instance: function () {
      ...
      this.init = callback => {
        ...
        function collectDependencies( node ) {
          ...
          [ ...node.children ].map( child => {
            ...
            /** gets index or URL of ccm component that corresponds to founded ccm Custom Element */
      ...
      this.start = callback => {
        ...
        my.dependencies.map( ( dependency, i ) => $.solveDependency( my.dependencies, i, check ) );
        check();
