...
( () => {
  ...
  const component = {
    ...
    config: {
      ...
      "content": [ "ccm.component", "https://ccmjs.github.io/akless-components/content/versions/ccm.content-5.3.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/content/resources/configs.js", "app_meta" ] ],
...
//    "user": [ "ccm.start", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.2.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/configs.js", "guest" ] ]
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        // render app metadata
        this.content.start( {
          root: this.element.querySelector( '#details' ),
          json2json: json => {
