...
( () => {
  ...
  const component = {
    ...
    name: 'app_manager', version: [ 1, 2, 0 ],
...
//    "user": [ "ccm.start", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.2.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/configs.js", "guest" ] ]
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        if ( !dataset || Object.keys( dataset ).length <= 1 ) return $.setContent( this.element, '<div style="padding: 1em">App not found</div>' );
        ...
        if ( await this.ccm.get.apply( null, dataset.source ) )
          ...
          $.setContent( this.element.querySelector( '#app .content' ), '<div style="padding: 1em">App Configuration not found</div>' );
        ...
        else $.removeElement( this.element.querySelector( '#details' ) );
        ...
        else $.removeElement( this.element.querySelector( '#handover' ) );
