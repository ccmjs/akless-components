 ...
 * - added result mode
 * - result data contains total amount of text gaps
 * - no extra user property in result data
 * - no login when finished
 * version 5.0.3 (31.01.2019):
 * - changed default instance configuration
 * - uses ccm v20.0.0
 * version 5.0.2 (20.12.2018):
 * - bug fix: strip HTML in keywords
 * - bug fix for progress bar
 * - uses ccm v18.6.6
