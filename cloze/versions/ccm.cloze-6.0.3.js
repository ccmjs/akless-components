 ...
 * @version 6.0.3
 * @changes
 * version 6.0.3 (27.11.2019):
 * - uses ccm v24.1.1
 * version 6.0.2 (09.11.2019):
 * - uses ccm v24.0.5
 * version 6.0.1 (10.10.2019):
 * - uses ccm v24.0.1
 * version 6.0.0 (07.04.2019):
 * - renamed property 'details' to 'sections' in result data
 * - no finish button and onfinish actions in result mode
 * (for older version changes see ccm.cloze-5.1.0.js)
 * TODO: $.html( my.text )
 */
