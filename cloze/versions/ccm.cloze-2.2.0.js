      ...
      this.start = function ( callback ) {
        ...
        function start() {
          ...
          function renderText() {
            ...
            self.ccm.helper.makeIterable( main_elem.querySelectorAll( '.gap' ) ).map( function ( gap_elem, i ) {
              ...
              if ( my.blank && my.keywords ) {
                gap_elem.appendChild( self.ccm.helper.html( { tag: 'input', type: 'text', oninput: onInput, onchange: onChange, size: size * 1.5 } ) );
                return;
              }
          ...
          function updateButtons() {
            ...
            if ( self.onfinish ) self.ccm.helper.setContent( finish_elem, self.ccm.helper.html( my.html.button, {
              disabled: '',
          ...
          function renderTimer() {
            ...
            if ( !my.time || ( !self.onfinish && !my.feedback ) ) return self.ccm.helper.removeElement( timer_elem );
