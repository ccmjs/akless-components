 ...
 * @version 1.0.1
 * @changes
 * version 1.0.1 (10.10.2019)
 * - uses ccm v24.0.1
 * - uses ccm.json_builder.js v1.4.2 as default
...
( () => {
  ...
  const component = {
    ...
    config: {
      ...
      "builder": [ "ccm.component", "https://ccmjs.github.io/akless-components/json_builder/versions/ccm.json_builder-1.4.2.js", { "html.inner.1": "", "directly": true } ]
