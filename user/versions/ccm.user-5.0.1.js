      ...
      this.login = ( callback, propagated ) => {
        ...
        switch ( my.realm ) {
          case 'guest':
            ...
            break;
          case 'demo':
            renderLoginForm( 'Demo Mode: Please enter any username', false, username => self.ccm.load( { url: 'https://ccm2.inf.h-brs.de', method: 'JSONP', params: { realm: my.realm, username: username } }, success ) );
            break;
          case 'hbrsinfkaul':
        ...
        function lea() {
          ...
          // render login form
          renderLoginForm( 'Sign in', true, ( username, password ) => {
         ...
         * @param {boolean} password - password is needed
         * @param {function} callback - when username and password has been entered
         */
        function renderLoginForm( title, password, callback ) {
          ...
          if ( self.parent && self.parent.element && self.parent.element.parentNode ) {
            ...
            parent = self.root.parentNode || document.createElement( 'div' );
          ...
          $.setContent( self.element, $.html( my.html.login_form, {
            ...
            abort: () => { if ( self.parent && self.parent.element && self.parent.element.parentNode ) { parent.appendChild( self.root ); self.parent.element.style.display = 'block'; } self.element && self.start(); },
            loginbox: () => {
          ...
          if ( !password ) self.element.querySelector( '#password-entry' ).style.display = 'none';
      ...
      this.logout = ( callback, propagated ) => {
        ...
        switch ( my.realm ) {
          case 'guest':
            ...
            break;
          case 'demo':
            self.ccm.load( { url: 'https://ccm2.inf.h-brs.de', method: 'JSONP', params: { realm: my.realm, token: self.data().token } }, success );
            break;
          case 'hbrsinfkaul':
