      ...
      this.login = function ( callback, propagated ) {
        ...
        switch ( my.sign_on ) {
          case 'guest':
            ...
            break;
          case 'demo':
            self.ccm.load( { jsonp: true, url: 'https://ccm2.inf.h-brs.de', params: { realm: 'ccm' } }, success );
            break;
          case 'hbrsinfkaul':
      ...
      this.logout = function ( callback, propagated ) {
        ...
        switch ( my.sign_on ) {
          case 'guest':
            ...
            break;
          case 'demo':
            self.ccm.load( { jsonp: true, url: 'https://ccm2.inf.h-brs.de', params: { realm: 'ccm', token: dataset.token } } );
            success();
            break;
          case 'hbrsinfkaul':
