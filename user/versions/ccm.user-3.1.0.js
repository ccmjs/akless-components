      ...
      this.login = ( callback, propagated ) => {
        ...
        switch ( my.sign_on ) {
          case 'guest':
            ...
            break;
          case 'demo':
            self.ccm.load( { url: 'https://ccm2.inf.h-brs.de', method: 'JSONP', params: { realm: 'ccm' } }, success );
            break;
          case 'hbrsinfkaul':
      ...
      this.logout = ( callback, propagated ) => {
        ...
        switch ( my.sign_on ) {
          case 'guest':
            ...
            break;
          case 'demo':
            self.ccm.load( { url: 'https://ccm2.inf.h-brs.de', method: 'JSONP', params: { realm: 'ccm', token: dataset.token } } );
            success();
            break;
          case 'hbrsinfkaul':
