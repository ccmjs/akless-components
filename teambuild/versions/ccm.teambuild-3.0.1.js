...
( function () {
  ...
  //  "max_teams": 5,
  //  "max_members": 3,
  //  "user": [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-8.0.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/configs.js", "demo" ] ],
        ...
        function addTeams() {
          ...
          function addTeam( team, i ) {
            ...
            const team_elem = $.html( self.html.team, {
              icon: self.icon.team,
              name: team.name ? team.name : ( self.names && self.names[ i ] ? self.names[ i ] : self.text.team + ' ' + ( i + 1 ) )
            } );
