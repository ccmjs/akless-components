...
ccm.files[ 'configs.js' ] = {
  ...
  "demo": {
    "css": [ "ccm.load", "https://ccmjs.github.io/ccm-components/teambuild/resources/akless.css" ],
    "data": {
      "store": [ "ccm.store", { "store": "teambuild", "url": "wss://ccm.inf.h-brs.de", "db": "redis" } ],
      "key": "demo"
    },
    "user": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/user/versions/ccm.user-2.0.0.min.js", { "logged_in": true, "sign_on": "guest" } ],
  ...
  "clicker": {
    ...
    "user": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/user/versions/ccm.user-2.0.0.min.js", { "logged_in": true, "sign_on": "demo" } ],
    "logger": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/log/versions/ccm.log-1.0.0.min.js", [ "ccm.get", "https://ccmjs.github.io/ccm-components/log/resources/configs.min.js", "greedy" ] ]
  },
  "se_ws17_gr1": {  // created for ccm.teambuild-1.0.0.js
    ...
    "editable": false,
    "max_members": 3,
    "user": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/user/versions/ccm.user-2.0.0.min.js", { "logged_in": true, "sign_on": "hbrsinfkaul" } ],
    "logger": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/log/versions/ccm.log-1.0.0.min.js", [ "ccm.get", "https://ccmjs.github.io/ccm-components/log/resources/configs.min.js", "se_ws17_teambuild" ] ]
  },
  ...
  "sks_ws17": {  // created for ccm.teambuild-1.0.0.js
    ...
    "editable": false,
    "user": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/user/versions/ccm.user-2.0.0.min.js", { "logged_in": true, "sign_on": "hbrsinfkaul" } ],
    "logger": [ "ccm.instance", "https://ccmjs.github.io/ccm-components/log/versions/ccm.log-1.0.0.min.js", [ "ccm.get", "https://ccmjs.github.io/ccm-components/log/resources/configs.min.js", "sks_ws17_teambuild" ] ]
  }
};