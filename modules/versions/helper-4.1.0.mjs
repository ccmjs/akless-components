...
export function progressBar( element, actual = 0, total = 100 ) {
  ...
  progress_bar.setAttribute( 'style', 'width: 100%; background-color: #ddd; border-radius: 10px; overflow: hidden;' );

  const progress = progress_bar.querySelector( 'div' );
  progress.setAttribute( 'style', 'width: 0%; height: 20px; background-color: #4CAF50;' );
