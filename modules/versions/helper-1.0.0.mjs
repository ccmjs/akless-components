...
/**
 * generates the HTML embed code of a <i>ccm</i>-based app
 * @param {string} component - URL of <i>ccm</i> component
 * @param {Object} store - settings of ccm data store which contains the <i>ccm</i> instance configuration data set
 * @param {string} app_id - dataset key of <i>ccm</i> instance configuration
