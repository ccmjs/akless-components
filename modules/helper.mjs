 ...
 * - bug fix for appURL(component,config,url):string -> component and config is now URL encoded
 * - updated privatize(instance,keys):void -> added 'inner' to not logged ccmjs-specific properties
 * - code refactoring -> export of constants with arrow functions instead of functions
 * - updated doc comments -> consider upcoming <i>ccmjs</i> version 26.0.0
...
/**
 * renders a TemplateResult from lit-html in an HTML element
 * @function
