 ...
 * @version 1.2.0
 * @changes
 * version 1.2.0 (09.05.2021)
 * - optional show of correct solution on feedback
...
//    "onstart": instance => { ... }
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        // render start screen
        $.setContent( this.element, $.html( this.html.start, { title: this.title, button: this.button, timer: this.timer, onclick: event => {
          event.preventDefault();
          this.timer = this.element.querySelector( 'input' ).value;
          next();
        } } ) );
