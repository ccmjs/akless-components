      ...
      this.ready = function ( callback ) {
        ...
        function uniformData() {
          ...
          my.questions.map( function ( question, i ) {
            ...
            self.ccm.helper.integrate( self.ccm.helper.filterProperties( my, 'text', 'description', 'answers', 'input', 'attributes', 'swap', 'escape', 'random', 'correct' ), question, true );
            ...
            question.answers.map( function ( answer, i ) {
              ...
              self.ccm.helper.integrate( self.ccm.helper.filterProperties( question, 'attributes', 'swap', 'escape' ), answer, true );
          ...
          delete my.text; delete my.description; delete my.answers; delete my.input; delete my.attributes; delete my.swap; delete my.escape; delete my.random; delete my.correct;
        ...
        function start() {
          ...
          function renderQuestion( question, i ) {
            ...
            question.elem = self.ccm.helper.html( my.html.question, {
              ...
              text:        question.escape ? self.ccm.helper.escapeHTML( question.text ) : question.text,
            ...
            function renderAnswer( answer ) {
              ...
              answer.elem = self.ccm.helper.html( my.html.answer, {
                id: answer.id,
                class: answer.class,
                text: answer.escape ? self.ccm.helper.escapeHTML( answer.text ) : answer.text
              } );
              ...
              function renderComments() {
                ...
                question.answers.map( function ( answer ) {
                  ...
                  if ( answer.comment ) self.ccm.helper.setContent( answer.elem.querySelector( '.comment' ), self.ccm.helper.html( my.html.comment, {
                    ...
                    comment: answer.escape ? self.ccm.helper.escapeHTML( answer.comment ) : answer.comment,
                  } ) );
