 ...
 * version 4.2.0 (01.03.2022):
 * - configurable placeholder of question prefix
 * version 4.1.2 (15.04.2020):
 * - bugfix for result mode
 * version 4.1.1 (25.02.2020):
        ...
        async function start() {
          ...
          function renderQuestion( question, i ) {
            ...
            question.elem = $.html( self.html.question, {
              ...
              prefix:      self.placeholder.prefix
            } );

            // question has no description? => remove description element
            self.questions.length <= 1 && $.remove( question.elem.querySelector( '.nr' ) );
            ...
            function renderAnswer( answer ) {
              ...
              async function addInput() {
                ...
                input = Object.assign( input, answer.attributes );
