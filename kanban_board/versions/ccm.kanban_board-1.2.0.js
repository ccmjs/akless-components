              ...
              $.solveDependency( card_dependency, card_inst => {
                ...
                card_inst.start( () => {
                  ...
                  card_inst.root.addEventListener( 'dblclick', () => {
                     ...
                     * @type {object}
                     */
                    const card_data = dataset.lanes[ i ].cards[ j ];
                    ...
                    my.data.store && my.data.store.set( dataset, () => self.start() );

                    // has logger? => log event
                    self.logger && self.logger.log( 'del', { lane: i, card: j, data: card_data } );
                  ...
                  function makeDraggable( card_elem ) {
                    ...
                    card_elem.addEventListener( 'dragstart', event => {
                      ...
                      // has logger? => log event
                      self.logger && self.logger.log( 'drag', { lane: pos[ 0 ], card: pos[ 1 ], data: dataset.lanes[ pos[ 0 ] ].cards[ pos[ 1 ] ] } );
                  ...
                  function makeDroppable( card_elem ) {
                    ...
                    card_elem.addEventListener( 'drop', event => {
                      ...
                      // has logger? => log event
                      self.logger && self.logger.log( 'drop', { from: from, to: to } );
