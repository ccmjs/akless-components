...
//    "ignore": { "card": { "component": "https://ccmjs.github.io/akless-components/kanban_card/versions/ccm.kanban_card-4.0.1.js", "config": {} } },
    ...
    Instance: function () {
      ...
      this.init = async () => {
        ...
        this.data.store.onchange = async priodata => {
          ...
          this.onchange && this.onchange( { instance: this, last_change: priodata.last_change, extern: true } );
        };
      ...
      this.start = async () => {
        ...
        dataset = await $.dataset( this.data );                   // get app data
