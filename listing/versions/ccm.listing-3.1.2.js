...
( () => {
  ...
  const component = {
    ...
    name: 'listing', version: [ 3, 1, 2 ],

    ccm: 'https://ccmjs.github.io/ccm/versions/ccm-20.7.3.js',
  ...
  //  "onrender": event => console.log( event )
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        if ( this.lang ) {
          const lang = this.element.querySelector( '#lang' );
          if ( lang ) {
            $.setContent( lang, this.lang.root );
