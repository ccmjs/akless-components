...
export const de = {
  ...
  "controls_dislike_info": "Jeder Kommentar hat einen Button, über den man ausgedrücken kann, dass der Kommentar einem <b>nicht</b> gefällt. Klicke erneut, um dies rückgängig zu machen. Eigene Kommentare können nicht markiert werden.",
  "controls_edit": "Nachträgliches ändern von Kommentaren",
  ...
  "controls_heart_info": "Jeder Kommentar hat einen Button, über den man ausgedrücken kann, dass man den Kommentar ganz besonders schön findet. Klicke erneut, um dies rückgängig zu machen. Eigene Kommentare können nicht markiert werden.",
  ...
  "controls_sort": "Änderbare Sortierung von Kommentaren",
  ...
  "text_comments_info": "Der Text der die aktuelle Anzahl an Kommentaren angibt. Nutze den Platzhalter \"%d\", er wird dynamisch durch die Anzahl der Kommentare ersetzt.",
  "text_delete": "Button-Tooltip: Kommentar löschen",
  "text_delete_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem Button zum Löschen eines eigenen Kommentars verbleibt.",
  ...
  "text_dislike_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem \"Unlike\"-Button eines Kommentars verbleibt.",
  "text_edit": "Button-Tooltip: Kommentar bearbeiten",
  "text_edit_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem Button zum Bearbeiten eines eigenen Kommentars verbleibt.",
  "text_heart": "Button-Tooltip: \"Herz\"",
  "text_heart_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem \"Herz\"-Button eines Kommentars verbleibt.",
  "text_like": "Button-Tooltip: \"Like\"",
  "text_like_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem \"Like\"-Button eines Kommentars verbleibt.",
  ...
  "text_recycle_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem Button zum Wiederherstellen eines gelöschten Kommentars verbleibt.",
  "text_report": "Button-Tooltip: Unangemessener Kommentar",
  "text_report_info": "Text der angezeigt wird, wenn der Mauszeiger länger über dem Button zur Markierung eines unangemessenen Kommentars verbleibt.",
  "text_sort_by_date": "Button: Sortierung nach Datum",
  "text_sort_by_date_info": "Beschriftung des Buttons der anzeigt, dass Kommentare nach Datum sortiert dargestellt werden.",
