  ...
  const component = {
    ...
    config: {
      ...
      "defaults": {
        ...
        "user": "['ccm.instance','https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.0.0.js',{'realm':'guest','title':'Guest Mode: Please enter any username'}]"
      },
      "target": [ "ccm.component", "https://ccmjs.github.io/akless-components/teambuild/versions/ccm.teambuild-3.1.0.js" ],
      "submit_button": true,
      "preview": true
