 ...
 * @version 3.0.3
 * @changes
 * version 3.0.3 (06.03.2019)
 * - updated default instance configuration
 * - bug fixes for handling of data and onfinish property
...
( function () {
  ...
  const component = {
    ...
    name: 'cloze_builder', version: [ 3, 0, 3 ],
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            ...
                            "class": "alert alert-info",
                            "inner": [
                              "If you select a sign-on mode, authentication is requested after the completion of the fill-in-the-blank exercise and the results are only submitted if the login was successful. If you do not select a sign-on mode the results are not submitted.<br>The various sign-on modes are described below.",
                              {
                                "tag": "h5",
                                "inner": "Guest Mode"
                              },
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "tag": "option",
                            "inner": "H-BRS FB02",
                            "value": "['ccm.instance','https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.0.0.js',{'realm':'hbrsinfkaul'}]"
                          }
                        ]
                      }
                    ]
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "id": "css-info",
                            "class": "alert alert-info",
                            "inner": "Choose between a layout format for your fill-in-the-blank exercise."
                          }
                        ]
                      },
                      {
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "id": "time-info",
                            "class": "alert alert-info",
                            "inner": "Specify the number of seconds available to solve the fill-in-the-blank exercise. The remaining number of seconds is then displayed visually. When the time is up, the exercise is submitted automatically. If you do not specify a time limit, no time limit is set."
                          }
                        ]
                      },
                      {
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "id": "keywords-info",
                            "class": "alert alert-info",
                            "inner": "Select whether the solution i.e. the words for the fill-in-the-blanks are already provided or if the users should enter the missing words. A list can be generated automatically or manually."
                          }
                        ]
                      },
                      {
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "id": "feedback-info",
                            "class": "alert alert-info",
                            "inner": "Choose whether direct feedback should be displayed for the solution. The solution can then be submitted via a submit button. You can choose feedback should only be provided or the correct solution should also be displayed."
                          }
                        ]
                      },
                      {
                      ...
                      },
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            ...
                            "class": "alert alert-info",
                            "inner": "Submit is offered as a default button but can be renamed."
                          }
                        ]
                      },
                      {
                    ...
                    "inner": [
                      {
                        ...
                        "inner": [
                          ...
                          },
                          {
                            "id": "blank-info",
                            "class": "alert alert-info",
                            "inner": "The length of the gaps can be displayed in a standard-length format or according to the number of characters of each word.<br>If Blank Gaps is selected, no characters of the gap will be displayed."
                          }
                        ]
                      },
                      {
