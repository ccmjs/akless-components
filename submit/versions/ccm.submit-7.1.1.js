...
( function () {
  ...
  //  "user": [ "ccm.instance", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.1.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/configs.js", "guest" ] ],
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        async function handleSeveral( several ) {
           ...
           * @type {Element}
           */
          const section = $.html( self.html.section, { name: name, add: addItem, del: delItem } );
        ...
        function feedback( elem ) {
          ...
          elem.classList.add( ( input_value !== '' ? $.stringify( input_value ) : undefined ) === $.stringify( data_value ) ? 'unchanged' : 'changed' );
