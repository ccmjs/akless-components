/**
 * @overview data-based resources of ccm-based web component for submitting data
...
//  "inner": [ "ccm.load", { "url": "https://ccmjs.github.io/akless-components/submit/resources/demo.html", "type": "data" } ],
    ...
    "json_builder": [ "ccm.component", "https://ccmjs.github.io/akless-components/json_builder/versions/ccm.json_builder-2.1.0.js", {
      "directly": true,
      "nosubmit": true
    } ],
    "onfinish": {
  ...
  "app_meta_edit": {
    "entries": [
      "<div class='pb-2 mt-4 mb-4 border-bottom'><h3>Edit of App Information</h3></div>",
      "<div class='form-group card card-body bg-light'>The more information about your app you type here, the better your app can be found by others.</div>",
      {
        "label": "<span style='color:red'>*</span>Title",
        "name": "title",
