    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        function select( elem, owner_or_prio ) {
          ...
          $.replace( $.html( { tag: 'select', inner: entries, onchange: onChange, onblur: function () { restore.call( this, elem ); } } ), elem );
        ...
        function input( elem ) {
          ...
          $.replace( $.html( { tag: 'input', type: 'date', value: data.deadline || '', oninput: onInput, onblur: function () { restore.call( this, elem ); } } ), elem );
