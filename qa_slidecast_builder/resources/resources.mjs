...
const builder_en = {
  ...
  "expand_info": "You can add a separate app, picture, or video. To add a slide, the slide can be added as an image. Please note that a slide added in this way will not be included in a slide download.",
  "expand_app": "App",
...
const builder_de = {
  ...
  "expand_info": "Sie können eine separate App, ein Bild oder ein Video hinzufügen. Um eine Folie hinzuzufügen, kann die Folie als Bild hinzugefügt werden. Bitte beachte, dass eine auf diese Weise hinzugefügte Folie in einem Download der Folien nicht enthalten sein wird.",
  "expand_app": "App",
