  ...
  //  "logger": [ "ccm.instance", "https://ccmjs.github.io/akless-components/log/versions/ccm.log-4.0.1.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/log/resources/configs.js", "greedy" ] ]
    ...
    Instance: function () {
      ...
      this.start = async () => {
         ...
         * @type {boolean}
         */
        const realtime = this.data.store.source().url.startsWith( 'ws' );
        ...
        realtime && $.removeElement( this.element.querySelector( '#reload' ) );
        ...
        else $.removeElement( members_section );
