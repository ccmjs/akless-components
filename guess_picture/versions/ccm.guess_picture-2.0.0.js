...
( () => {
  ...
  const component = {
    ...
    name: 'guess_picture', version: [ 2, 0, 0 ],
    ...
    config: {
      ...
      "max_width": 500,
      "picture": "",
//    "pictures": [ { "image": "", "solution": [] } ],
//    "lang": [ "ccm.instance", "https://ccmjs.github.io/tkless-components/lang/versions/ccm.lang-1.0.0.js" ],
//    "logger": [ "ccm.instance", "https://ccmjs.github.io/akless-components/log/versions/ccm.log-5.0.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/log/resources/configs.js", "greedy" ] ],
//    "onfinish": { "log": true },
      "size": 4,
      "solution": [],
//    "user": [ "ccm.start", "https://ccmjs.github.io/akless-components/user/versions/ccm.user-9.6.0.js", [ "ccm.get", "https://ccmjs.github.io/akless-components/user/resources/resources.js", "guest" ] ]
    },
    ...
    Instance: function () {
      ...
      this.ready = async () => {
        ...
        // prevent change of initial given pictures data
        pictures = $.clone( this.pictures );
      ...
      this.start = async () => {
        ...
        // many pictures? => choose next picture randomly
        if ( pictures ) {
          const i = Math.floor( Math.random() * pictures.length );
          this.picture = pictures[ i ].image;
          this.solution = pictures[ i ].solution;
          pictures.splice( i, 1 );
          if ( !pictures.length )
            pictures = $.clone( this.pictures );
        }
        ...
        this.logger && this.logger.log( 'start', { picture: this.picture, solution: $.clone( this.solution ), pictures: $.clone( pictures ) } );
        ...
        const finish = () => {
          ...
          if ( !this.onfinish ) $.remove( this.element.querySelector( '#finish' ) );
