 ...
 * @version 2.1.0
 * @changes
 * version 2.1.0 (27.03.2020):
 * - uses ccm v25.2.0
 * - uses helper.mjs v4.1.1 as default
 * - added config property 'height' for minimum height of the editor
...
( () => {
  ...
  const component = {
    ...
    name: 'json_builder', version: [ 2, 1, 0 ],
  ...
  //  "replacer": ( key, value ) => typeof value === 'string' ? undefined : value,
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        if ( this.height ) editor.getScrollerElement().style.minHeight = this.height;
