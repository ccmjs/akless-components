...
( () => {
  ...
  const component = {
    ...
    config: {
      "css": [ "ccm.load", "https://ccmjs.github.io/akless-components/markdown/resources/styles.min.css" ],
      "helper": [ "ccm.load", "https://ccmjs.github.io/akless-components/modules/helper.min.mjs" ],
      "html": { "tag": "main" },
